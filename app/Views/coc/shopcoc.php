    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        productItems.forEach(item => {
            item.addEventListener('click', function (event) {
                ...
                window.location.href = `<?= base_url('produkcoc/show/') ?>${productId}?name=${encodeURIComponent(productName)}&price=${productPrice}`;
            });
        });
    });
</script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span class="breadcrumb"><a href="#">Home</a> >CLASH OF CLANS</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section trending">
        <div class="container">
            <ul class="trending-filter">
                <li>
                    <a class="is_active" href="#!" data-filter="*">GEMS</a>
                </li>
            </ul>
            <div class="row trending-box">
                <?php foreach ($produkcoc as $item): ?>
                    <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
                        <div class="item">
                            <form action="/produkcoc/<?= $item['id']; ?>/new" method="get">
                                <div class="thumb">
                                    <a href="/produkcoc/<?= $item['id']; ?>"><img src="/assets/images/logoCOC.png" alt=""></a>
                                    <span class="price"><?php echo $item['harga']; ?></span>
                                </div>
                                <div class="down-content">
                                    <span class="category">GEMS</span>
