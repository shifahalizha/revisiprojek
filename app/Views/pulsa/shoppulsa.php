    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        productItems.forEach(item => {
            item.addEventListener('click', function (event) {
                ...
                window.location.href = `<?= base_url('produkpulsa/show/') ?>${productId}?name=${encodeURIComponent(productName)}&price=${productPrice}`;
            });
        });
    });
</script>
    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>PULSA</h3>
                    <span class="breadcrumb"><a href="#">Home</a> >PULSA</span>
                </div>
            </div>
        </div>
    </div>
