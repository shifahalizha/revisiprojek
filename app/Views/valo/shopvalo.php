    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        productItems.forEach(item => {
            item.addEventListener('click', function (event) {
                ...
                window.location.href = `<?= base_url('produk/show/') ?>${productId}?name=${encodeURIComponent(productName)}&price=${productPrice}`;
            });
        });
    });
</script>
    ...
    <div class="page-heading header-text">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3>VALORANT</h3>
                    <span class="breadcrumb"><a href="#">Home</a> >VALORANT</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section trending">
        <div class="container">
            <ul class="trending-filter">
                <li>
                    <a class="is_active" href="#!" data-filter="*">VALORANT POINT</a>
                </li>
            </ul>
            <div class="row trending-box">
                <?php foreach ($produkvalo as $item): ?>
                        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 adv">
                            <div class="item">
                                <form action="/produk/<?= $item['id']; ?>/new" method="get">
                                    <div class="thumb">
                                        <a href="/produk/<?= $item['id']; ?>"><img src="/assets/images/valogrup.jpg" alt=""></a>
                                        <span class="price"><?php echo $item['harga']; ?></span>
                                    </div>
                                    <div class="down-content">
                                        <span class="category">VALORANT POINTS</span>
